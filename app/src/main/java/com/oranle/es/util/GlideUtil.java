...
/*
 * if you need Trans or round  add this implementation 'jp.wasabeef:glide-transformations:3.3.0' to your project
 * */
public class GlideUtil {

    public static final int placeholderSoWhite = R.drawable.default_icon;
    public static final int errorSoWhite = R.drawable.default_icon;
